...
public class Lesson8cFragment extends Fragment {

    private static final String FORMAT_HTML_COLOR = "%1X";

    public Lesson8cFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lesson8c, container, false);
        setHasOptionsMenu(true);
        setHtml((WebView) view.findViewById(R.id.web_view),
                getString(R.string.lesson8c),
