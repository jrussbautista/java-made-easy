...
public class Program14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_program14);
        ...
        btnShowOutput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Output14.class);
        ...
        mWebView.loadUrl("file:///android_asset/www/n.html");
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            builder.setTitle("Reverse Number");
            builder.setMessage(R.string.p14);
