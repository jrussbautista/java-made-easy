...
public class Program3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShowOutput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Output3.class);
        ...
        mWebView.loadUrl("file:///android_asset/www/c.html");
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            builder.setTitle("Prime Number");
            builder.setMessage(R.string.p3);
