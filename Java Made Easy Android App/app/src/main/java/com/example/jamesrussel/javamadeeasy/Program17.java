...
public class Program17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShowOutput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Output17.class);
        ...
        mWebView.loadUrl("file:///android_asset/www/q.html");
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            builder.setTitle("Count the Digit in Number");
            builder.setMessage(R.string.p17);
