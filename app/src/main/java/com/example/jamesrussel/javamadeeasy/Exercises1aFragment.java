 ...
 */
public class Exercises1aFragment extends Fragment {
    TextView a = null;
    TextView a1= null;
    TextView a2 = null;
    public Exercises1aFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_exercises1a, container, false);

        setHasOptionsMenu(true);
        a = (TextView) view.findViewById(R.id.ex1a);
        a.setText(Html.fromHtml(getString(R.string.ex1a)));
        a1  = (TextView) view.findViewById(R.id.a1);
        a1.setText(Html.fromHtml(getString(R.string.a1)));
        a2 = (TextView) view.findViewById(R.id.a2);
        a2.setText(Html.fromHtml(getString(R.string.a2)));
