...
public class Lesson10cFragment extends Fragment {

    private static final String FORMAT_HTML_COLOR = "%1X";

    public Lesson10cFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lesson10c, container, false);
        setHasOptionsMenu(true);
        setHtml((WebView) view.findViewById(R.id.web_view),
                getString(R.string.lesson10c),
