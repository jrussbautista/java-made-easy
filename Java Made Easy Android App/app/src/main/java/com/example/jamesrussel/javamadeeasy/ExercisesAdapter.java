...
/**
 * Created by James Russel on 9/7/2016.
 */
public class ExercisesAdapter extends BaseAdapter {

    private Context c;

    String[]names={"Creating Your First Java Classes", "Control Statements", "Functions and Subroutines", "More Object Concepts", "Making Decisions", "Looping", "Characters, Strings, and the StringBuilder", "Arrays",
            "Advanced Array Concepts", "Introduction to Inheritance"};
    ...
    public ExercisesAdapter(Context ctx)
    {
        this.c=ctx;
    }
