...
public class Lesson10aFragment extends Fragment {

    private static final String FORMAT_HTML_COLOR = "%1X";

    public Lesson10aFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lesson10a, container, false);
        setHasOptionsMenu(true);
        setHtml((WebView) view.findViewById(R.id.web_view),
                getString(R.string.lesson10a),
