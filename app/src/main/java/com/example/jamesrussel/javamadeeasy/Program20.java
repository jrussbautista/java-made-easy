...
public class Program20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_program20);
        ...
        btnShowOutput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Output20.class);
        ...
        mWebView.loadUrl("file:///android_asset/www/t.html");
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            builder.setTitle("Armstrong Number");
            builder.setMessage(R.string.p11);
