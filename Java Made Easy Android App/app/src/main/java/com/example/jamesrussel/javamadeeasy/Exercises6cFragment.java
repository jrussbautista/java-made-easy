 ...
 */
public class Exercises6cFragment extends Fragment {
    TextView a = null;
    TextView a1= null;
    public Exercises6cFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_exercises6c, container, false);

        setHasOptionsMenu(true);
        a = (TextView) view.findViewById(R.id.ex1a);
        a.setText(Html.fromHtml(getString(R.string.ex6e)));
        a1  = (TextView) view.findViewById(R.id.a1);
        a1.setText(Html.fromHtml(getString(R.string.ex6f)));
