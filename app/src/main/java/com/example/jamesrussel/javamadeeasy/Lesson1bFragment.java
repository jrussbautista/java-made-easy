...
public class Lesson1bFragment extends Fragment {

    private static final String FORMAT_HTML_COLOR = "%1X";

    public Lesson1bFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lesson1b, container, false);
        setHasOptionsMenu(true);
        setHtml((WebView) view.findViewById(R.id.web_view),
                getString(R.string.lesson1b),
