 ...
 */
public class Exercises3aFragment extends Fragment {
    TextView a = null;
    TextView a1= null;
    public Exercises3aFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_exercises3a, container, false);

        setHasOptionsMenu(true);
        a = (TextView) view.findViewById(R.id.ex1a);
        a.setText(Html.fromHtml(getString(R.string.ex3a)));
        a1  = (TextView) view.findViewById(R.id.a1);
        a1.setText(Html.fromHtml(getString(R.string.ex3b)));
