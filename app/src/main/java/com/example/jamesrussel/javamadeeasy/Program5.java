...
public class Program5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShowOutput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Output5.class);
        ...
        mWebView.loadUrl("file:///android_asset/www/e.html");
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            builder.setTitle("Swap Without Using Third Variable");
            builder.setMessage(R.string.p5);
