...
public class Video19  extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener{

    public static final String API_KEY ="AIzaSyBu9QalG-8DDJRpxcqTn_-h7UAiI5dt3G8";
    public static final String VIDEO_KEY ="GnLtvmeGAWA";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent homeIntent = new Intent(getApplicationContext(), Video20.class);
