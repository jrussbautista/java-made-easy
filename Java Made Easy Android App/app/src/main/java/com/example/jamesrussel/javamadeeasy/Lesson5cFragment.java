...
public class Lesson5cFragment extends Fragment {

    private static final String FORMAT_HTML_COLOR = "%1X";

    public Lesson5cFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lesson5c, container, false);
        setHasOptionsMenu(true);
        setHtml((WebView) view.findViewById(R.id.web_view),
                getString(R.string.lesson5c),
